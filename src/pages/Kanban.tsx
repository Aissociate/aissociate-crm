                    ...
                    return (
                      <div key={carte.id} className="card p-3">
                        ...
                        <div className="mt-2 flex justify-between">
                          <button disabled={idx === 0} onClick={() => moveCarte(carte, -1)} className="rounded p-1 text-muted hover:bg-surface-2 disabled:opacity-30"><ChevronLeft className="h-4 w-4" /></button>
                          <button disabled={idx === colonnes.length - 1} onClick={() => moveCarte(carte, 1)} className="rounded p-1 text-muted hover:bg-surface-2 disabled:opacity-30"><ChevronRight className="h-4 w-4" /></button>
                        </div>
                      </div>
                    );
                  })}
